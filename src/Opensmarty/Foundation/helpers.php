...
if (! function_exists('current_auth_user')) {
     ...
     * @return \Opensmarty\Model\Foundation\User
    ...
    function current_auth_user($throwException = true)
    {
        ...
        if (! $user || ! ($user instanceof \Opensmarty\Model\Foundation\User)) {
            if ($throwException) {
...
if (! function_exists('phone_model_from')) {
     ...
     * @param string $phone_number
     * @param string $country_code An ISO 3166-1 two letter country code
     * @return \Opensmarty\Model\Basic\PhoneNumberModel
     */
    function phone_model_from($phone_number, $country_code)
    {
        return new \Opensmarty\Model\Basic\PhoneNumberModel($phone_number, $country_code);
    }
